...
export interface ApiAlbumAlbum extends Struct.CollectionTypeSchema {
	...
	attributes: {
		category: Schema.Attribute.Enumeration<
			["environment", "sanitation", "roads", "earthquake", "formation", "events", "volunteers"]
		> &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
	...
	info: {
		description: "Articles et actualit\u00E9s du site";
		displayName: "Article";
		pluralName: "articles";
	...
	attributes: {
		...
		category: Schema.Attribute.Enumeration<["news", "event", "project", "solidarity"]> &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
...
export interface ApiMembershipMembership extends Struct.CollectionTypeSchema {
	...
	info: {
		description: "Demandes d'adh\u00E9sion \u00E0 l'association";
...
export interface ApiPartnerPartner extends Struct.CollectionTypeSchema {
	...
	info: {
		description: "Partenaires de l'association";
	...
	attributes: {
		category: Schema.Attribute.Enumeration<["international", "institutional", "national"]> &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		domain: Schema.Attribute.Enumeration<["environment", "sanitation", "infrastructure", "social"]> &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
		...
		slug: Schema.Attribute.UID<"title">;
		statusType: Schema.Attribute.Enumeration<["inProgress", "done", "operational", "planned"]> &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
...
export interface ApiTimelineEventTimelineEvent extends Struct.CollectionTypeSchema {
	collectionName: "timeline_events";
	info: {
		displayName: "\u00C9v\u00E9nement Timeline";
	...
	attributes: {
		...
		endYear: Schema.Attribute.Integer &
			...
			>;
		locale: Schema.Attribute.String;
		localizations: Schema.Attribute.Relation<"oneToMany", "api::timeline-event.timeline-event">;
		publishedAt: Schema.Attribute.DateTime;
