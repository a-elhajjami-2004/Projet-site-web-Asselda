...
export default function PartenairesPage() {
	...
	const translatedCategories = translations.ar.pages.partners.categories;

	return (
		<main className={styles.page}>
			<section className="hero-section">
				<div className="max-w-3xl z-10">
					<h1 className="hero-title">شركاؤنا</h1>
					<p className="hero-copy">
						تعمل جمعية أسلدة بالتعاون الوثيق مع مؤسسات عمومية ومنظمات وطنية ودولية لتعظيم أثر أنشطتها.
					</p>
				</div>
			</section>
			...
			<Suspense fallback={<div className="text-center py-12">جارٍ تحميل الشركاء...</div>}>
				<PartnerCards partners={getPartners("ar")} active={active} lang="ar" />
			</Suspense>
		</main>
	);
}
