...
export default function Home() {
	const LOGO_SRC =
		"https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-original-577x577/s3/0000/0502/brand.gif?itok=ywZxw0rj";
	return (
		<>
			<main>
				<section
					className={styles.heroBanner}
					style={{ backgroundImage: 'url("http://localhost:1337/uploads/banner_79228a7d13.jpeg")' }}>
					...
					<div className={styles.content}>
						...
						<p className={styles.subtitle}>
							جمعية أسيلدا تعمل منذ عام 1996 على البيئة والتنمية الريفية ورعاية الأسر في منطقة أسني
							والحوز.
						</p>

						<div className={styles.buttons}>
							<a href="/ar/projets" className={styles.primaryBtn}>
								اكتشف مشاريعنا
							</a>

							<a href="/ar/rejoindre" className={styles.secondaryBtn}>
								ادعمنا
							</a>
						</div>
					</div>
						...
						<div className={styles.news_grid}>
							<article className={styles.news_card}>
								...
								<p className={styles.news_card_text}>
									خلال الجمعية العامة الاستثنائية في 3 فبراير 2025، انتخب الأعضاء المكتب التنفيذي
									الجديد لمدة 5 سنوات برئاسة السيد سمير أهرام.
								</p>
							</article>
							...
							<article className={styles.news_card}>
								...
								<p className={styles.news_card_text}>
									سمح برنامج أوراش الوطني 2022 بتعبيد كامل الشوارع والساحات العامة في الثلاث دوارات،
									مما حسّن بشكل كبير إطار حياة السكان.
								</p>
							</article>
						</div>

						<div className={styles.news_footer}>
							<a href="/ar/actualites" className={styles.news_btn}>
								جميع الأخبار ←
							</a>
						</div>
					</div>
					...
					<div className={styles.cta_container}>
						...
						<div className={styles.cta_banner}>
							...
							<div className={styles.cta_overlay}>
								<a href="/ar/Nous rejoindre" className={styles.cta_button}>
									كن عضوًا ←
								</a>
