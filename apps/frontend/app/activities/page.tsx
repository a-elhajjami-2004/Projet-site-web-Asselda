...
import { projects, domains, getDomainColor, type Domain } from "@/lib/projects";
  ...
  return (
    <main>
      ...
      <section className={styles.activitiesHero}>
        <h1>Nos Activités</h1>
        <p>
          De l'eau potable aux espaces réhabilitées, en passant par la formation et le
          soutien social, découvrez comment l'association transforme le quotidien
          des habitants de Douar Asselda.
        </p>
      </section>
          ...
          <div className={styles.filterContainer}>
            ...
            <button
              className={`${styles.filterButton} ${
                selectedDomain === "Tous" ? styles.active : ""
              }`}
            ...
            {domains.map((domain) => (
              <button
                key={domain}
                className={`${styles.filterButton} ${
                  selectedDomain === domain ? styles.active : ""
                }`}
