						...
						<div className={styles.news_grid}>
							...
							<article className={styles.news_card}>
								...
								<p className={styles.news_card_text}>
									...
									septembre 2023 : distribution d'aide, montage de tentes, soutien psychologique et
							...
							<article className={styles.news_card}>
								...
								<p className={styles.news_card_text}>
									...
									publiques des trois douars, améliorant significativement le cadre de vie des
									habitants.
								</p>
							</article>
						</div>
