    ...
    <main>
      ...
      <section className={styles.projectsHero}>
        ...
        <div className={styles.projectsContent}>
          <h1>Nos Projets</h1>
          <p>
            Depuis 1996, l'Association Asselda a conçu et réalisé des projets
            structurants pour la communauté de Douar Asselda. Chaque projet répond
            à un besoin réel, identifié avec et pour ses habitants.
          </p>
        </div>
      </section>
