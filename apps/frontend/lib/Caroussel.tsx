		...
		<section className={styles.projectsSection}>
			<div className={styles.projectsWrapper}>
				<div className={styles.projectsCarousel}>
					<button className={styles.carouselBtn} onClick={handlePrev} aria-label="Projet précédent">
						&#10094;
					</button>
					...
					<button className={styles.carouselBtn} onClick={handleNext} aria-label="Projet suivant">
						&#10095;
					</button>
				</div>
